...
public:
    ...
    // clang-format on
    {
        const auto [_, id2_sv, lat_sv, lng_sv, elev_sv, lvl_sv] = common::extractFirstN<6>(str, ",");
        ...
        if(!id2_opt or !lat_opt or !lng_opt or !elev_opt or !lvl_opt) {
            return std::nullopt;
        }
    ...
    // clang-format on
    {
        const auto [_, id2_sv, lat_sv, lng_sv, elev_sv] = common::extractFirstN<5>(str, ",");
        ...
        if(!lat_opt or !lng_opt or !id2_opt or !elev_opt) {
            return std::nullopt;
        }
